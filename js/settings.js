    ...
    HandlePost() {
        ...
        if (this.post.size) {
            ...
            if (this.GetStorage('default')) {
                let lines = [
                    [ '2022-01-01', '00:00', '1,31559', '0', '21' ],
                    [ '2022-01-01', '17:00', '1,78039', '0', '21' ],
                    [ '2022-01-01', '20:00', '1,31559', '0', '21' ],
                    [ '2022-04-01', '00:00', '1,31559', '0', '21' ],
                    [ '2022-05-01', '00:00', '1,27159', '0', '21' ],
                    [ '2022-07-01', '00:00', '1,75599', '0', '21' ],
                    [ '2022-07-01', '17:00', '1,64039', '0', '21' ],
                    [ '2022-07-01', '20:00', '1,75599', '0', '21' ],
                    [ '2022-10-01', '00:00', '1,13559', '0', '21' ],
                    [ '2022-10-01', '17:00', '1,60039', '0', '21' ],
                    [ '2022-10-01', '20:00', '1,13559', '0', '21' ],
                    [ '2023-01-01', '00:00', '0,28333', '0', '21' ],
                    [ '2023-01-01', '06:00', '0,60933', '0', '21' ],
                    [ '2023-01-01', '17:00', '1,58717', '0', '21' ],
                    [ '2023-01-01', '21:00', '0,60933', '0', '21' ],
                    [ '2023-02-01', '00:00', '0,30397', '0', '21' ],
                    [ '2023-02-01', '06:00', '0,67141', '0', '21' ],
                    [ '2023-02-01', '17:00', '1,77357', '0', '21' ],
                    [ '2023-02-01', '21:00', '0,67141', '0', '21' ],
                    [ '2023-04-01', '00:00', '0,30397', '0', '21' ],
                    [ '2023-04-01', '06:00', '0,39581', '0', '21' ],
                    [ '2023-04-01', '17:00', '1,83669', '0', '21' ],
                    [ '2023-04-01', '21:00', '0,39581', '0', '21' ],
                    [ '2023-07-01', '00:00', '0,99297', '0', '21' ],
                    [ '2023-07-01', '06:00', '1,08569', '0', '21' ],
                    [ '2023-07-01', '17:00', '1,52569', '0', '21' ],
                    [ '2023-07-01', '21:00', '1,08481', '0', '21' ],
                ];
